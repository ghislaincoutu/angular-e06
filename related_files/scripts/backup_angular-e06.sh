...
destination=/home/xd21/angular-e06/related_files/publication
...
destination=/home/xd21/angular-e06/related_files/publication/pub_angular-e06t01_`(date +%Y%m%d-%H%M)`.tar.gz
tar -czvf $destination $source

source=/var/www/html/d002/angular-e06t03/
destination=/home/xd21/angular-e06/related_files/publication/pub_angular-e06t03_`(date +%Y%m%d-%H%M)`.tar.gz
tar -czvf $destination $source
